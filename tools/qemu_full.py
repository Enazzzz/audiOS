...
def main() -> int:
	...
	try:
		...
		help = expect(master, proc, "help", ("tone", "play", "music", "storage", "reboot", "shutdown", "script", "edit", "tetris", "type", "drives", "update", "floppy", "ide", "link", "audio help"))
		...
		expect(master, proc, "pwd", ("D:/",))
		expect(master, proc, "cd C:", tuple())
		expect(master, proc, "pwd", ("C:/audio",))
		expect(master, proc, "cd D:", tuple())
		expect(master, proc, "pwd", ("D:/",))
		...
		expect(master, proc, "type /os/demo.aos", ("pwd", "version"))
		...
		checked.append("FAT ls/cd/pwd/mkdir/cp/mv/type/touch/info/storage/mount/script/rm")
