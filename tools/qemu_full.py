...
def main() -> int:
	...
	try:
		...
		expect(master, proc, "ls", ("audio",))
		expect(master, proc, "cd audio", tuple())
		expect(master, proc, "pwd", ("/audio",))
		expect(master, proc, "ls", ("test.wav",))
		expect(master, proc, "cd /", tuple())
		expect(master, proc, "mkdir scratch", ("created",))
		expect(master, proc, "cp audio/test.wav scratch/t.wav", ("copied",), 20.0)
		...
		expect(master, proc, "cat demo.aos", ("pwd", "version"))
		expect(master, proc, "storage", ("FAT32", "free"))
		expect(master, proc, "mount", ("FAT32", "mounted"))
		expect(master, proc, "script demo.aos", ("/", ver), 15.0)
		...
		expect(master, proc, "save s audio/full.wav", ("saved",), 20.0)
		send(master, "play s")
