 ...
 * of the same build.
 *
 * 0.0.6 is the music system on the ASRock 960GM-GS3 FX (AMD FX, SB710, ALC662).
 */
#define AUDIOS_NAME		"audiOS"
#define AUDIOS_VERSION_MAJOR	0
#define AUDIOS_VERSION_MINOR	0
#define AUDIOS_VERSION_PATCH	6
#define AUDIOS_VERSION_STRING	"0.0.6"
#define AUDIOS_BANNER		"audiOS 0.0.6"
