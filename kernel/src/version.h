 ...
 * of the same build.
 *
 * 0.0.5 is tailored to the ASRock 960GM-GS3 FX (AMD FX, SB710, ALC662).
 */
#define AUDIOS_NAME		"audiOS"
#define AUDIOS_VERSION_MAJOR	0
#define AUDIOS_VERSION_MINOR	0
#define AUDIOS_VERSION_PATCH	5
#define AUDIOS_VERSION_STRING	"0.0.5"
#define AUDIOS_BANNER		"audiOS 0.0.5"
