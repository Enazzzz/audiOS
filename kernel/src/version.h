 ...
 * 0.6.0: that slave OS boots an IDE HDD. The FX kernel talks PATA, formats
...
#define AUDIOS_VERSION_STRING	"0.6.0"
#define AUDIOS_BANNER		"audiOS 0.6.0"
...
#define AUDIOS_SLAVE_BANNER	"audiOS slave 0.6.0"
